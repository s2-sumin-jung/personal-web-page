...
- 3개 서비스 카드 (한 줄 배치)
  ...
  - 랜딩페이지
  - 웹 애플리케이션
- 노션 견적서 링크 CTA 버튼 (Primary 컬러)

#### 코칭 (Coaching) - 한국어 버전만
- 2개 서비스 카드 (한 줄 배치)
  - 라이프 코칭
  - 커리어 코칭
- 노션 견적서 링크 CTA 버튼 (녹색 컬러)
- `i18n.language === 'ko'` 조건부 렌더링
...
- `freelance.*`: 외주 문의 (웹개발, 코칭 - 코칭은 한국어만)
- `common.*`: 공통 (Present 등)
